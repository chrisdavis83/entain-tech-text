...
//Allows sorting in either ascending order or descending order
type ListRacesRequest_SortBy int32

const (
	ListRacesRequest_ASC  ListRacesRequest_SortBy = 0
	ListRacesRequest_DESC ListRacesRequest_SortBy = 1
)

// Enum value maps for ListRacesRequest_SortBy.
var (
	ListRacesRequest_SortBy_name = map[int32]string{
		0: "ASC",
		1: "DESC",
	}
	ListRacesRequest_SortBy_value = map[string]int32{
		"ASC":  0,
		"DESC": 1,
	}
)

func (x ListRacesRequest_SortBy) Enum() *ListRacesRequest_SortBy {
	p := new(ListRacesRequest_SortBy)
	*p = x
	return p
}

func (x ListRacesRequest_SortBy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (ListRacesRequest_SortBy) Descriptor() protoreflect.EnumDescriptor {
	return file_racing_racing_proto_enumTypes[0].Descriptor()
}

func (ListRacesRequest_SortBy) Type() protoreflect.EnumType {
	return &file_racing_racing_proto_enumTypes[0]
}

func (x ListRacesRequest_SortBy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use ListRacesRequest_SortBy.Descriptor instead.
func (ListRacesRequest_SortBy) EnumDescriptor() ([]byte, []int) {
	return file_racing_racing_proto_rawDescGZIP(), []int{1, 0}
}
...
const (
	Race_OPEN   Race_Status = 0
	Race_CLOSED Race_Status = 1
)
...
func (x *RaceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RaceRequest) ProtoMessage() {}

func (x *RaceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_racing_racing_proto_msgTypes[0]
...
// Deprecated: Use RaceRequest.ProtoReflect.Descriptor instead.
func (*RaceRequest) Descriptor() ([]byte, []int) {
	return file_racing_racing_proto_rawDescGZIP(), []int{0}
}

func (x *RaceRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
type ListRacesRequest struct {
	...
	//Allows the input of a column to sort by
	OrderBy string                  `protobuf:"bytes,2,opt,name=orderBy,proto3" json:"orderBy,omitempty"`
	SortBy  ListRacesRequest_SortBy `protobuf:"varint,3,opt,name=sortBy,proto3,enum=racing.ListRacesRequest_SortBy" json:"sortBy,omitempty"`
}
...
func (x *ListRacesRequest) GetSortBy() ListRacesRequest_SortBy {
	if x != nil {
		return x.SortBy
	}
	return ListRacesRequest_ASC
}
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	0x0a, 0x0b, 0x52, 0x61, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x0e, 0x0a,
	...
	,
	...
	0x79, 0x53, 0x68, 0x6f, 0x77, 0x56, 0x69, 0x73, 0x69, 0x62, 0x6c, 0x65, 0x22, 0x98, 0x02, 0x0a,
	...
	0x61, 0x74, 0x75, 0x73, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x13, 0x2e, 0x72, 0x61, 0x63,
	0x69, 0x6e, 0x67, 0x2e, 0x52, 0x61, 0x63, 0x65, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x1e, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x12, 0x08, 0x0a, 0x04, 0x4f, 0x50, 0x45, 0x4e, 0x10, 0x00, 0x12, 0x0a, 0x0a, 0x06, 0x43,
	0x4c, 0x4f, 0x53, 0x45, 0x44, 0x10, 0x01, 0x32, 0x81, 0x01, 0x0a, 0x06, 0x52, 0x61, 0x63, 0x69,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x33, 0x0a, 0x04, 0x52, 0x61, 0x63, 0x65, 0x12, 0x13,
	0x2e, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x61, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x61, 0x63,
...
var file_racing_racing_proto_goTypes = []interface{}{
	(ListRacesRequest_SortBy)(0),   // 0: racing.ListRacesRequest.SortBy
	(Race_Status)(0),               // 1: racing.Race.Status
	(*RaceRequest)(nil),            // 2: racing.RaceRequest
	(*ListRacesRequest)(nil),       // 3: racing.ListRacesRequest
	(*RaceResponse)(nil),           // 4: racing.RaceResponse
...
var file_racing_racing_proto_depIdxs = []int32{
	...
	0, // 1: racing.ListRacesRequest.sortBy:type_name -> racing.ListRacesRequest.SortBy
	7, // 2: racing.RaceResponse.race:type_name -> racing.Race
	...
	2, // 7: racing.Racing.Race:input_type -> racing.RaceRequest
	5, // 8: racing.Racing.ListRaces:output_type -> racing.ListRacesResponse
	4, // 9: racing.Racing.Race:output_type -> racing.RaceResponse
